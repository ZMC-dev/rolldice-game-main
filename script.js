...
document.querySelector('.btn-roll').addEventListener('click', function () {
        if (gamePlaying) {
            ...
            var img1 = document.getElementById('dice1.png');
            var img2 = document.getElementById('dice2.png');
            var img3 = document.getElementById('dice3.png');
            var img4 = document.getElementById('dice4.png');
            var img5 = document.getElementById('dice5.png');
            var img6 = document.getElementById('dice6.png');
...
document.querySelector('.btn-hold').addEventListener('click', function () {
    if (gamePlaying) {
        ...
        //check if player won the game with 100 points
